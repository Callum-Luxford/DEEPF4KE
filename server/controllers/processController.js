...
exports.processFile = async (req, res) => {
  ...
  try {
    ...
    // Ensure directories exist
    const facesPath = path.join(__dirname, "../uploads/faces");
    const reelsPath = path.join(__dirname, "../uploads/reels");
    const outputDirectory = path.join(__dirname, "../uploads/outputs");

    ensureDirectoryExists(facesPath);
    ensureDirectoryExists(reelsPath);
